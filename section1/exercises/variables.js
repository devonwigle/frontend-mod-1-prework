...
// log that variable to the console.
var words = "Harry Potter must not return to Hogwarts!";
console.log(words);
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
// I used a string for firstName since names are typically made of letters.
// I used a boolean since a person is generally hungry or not hungry
// I used numbers for numberOfPets since most people will respond to the question with a numerical value
